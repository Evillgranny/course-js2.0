...
function t5() {
    ...
    for (let i = 1; i < 18; i++)
        if (i % 2 == 0)
            ...
            counter += i + '_*'
    document.querySelector('.out-5').textContent = counter
}
...
function t7() {
    ...
    for (let i = inputVal; i >= 0; i--)
        counter += i + ' '
    document.querySelector('.out-7').textContent = counter
}
...
function t8() {
    let counter = '',
        input81Val = document.querySelector('.i-81').value,
        input82Val = document.querySelector('.i-82').value
    for (let i = input81Val; i <= input82Val; i++)
        counter += i + ' '
    document.querySelector('.out-8').textContent = counter
}
...
// По нажатию кнопки b-9 должна запускаться функция f9, которая выводит в out-9 числа
// от меньшего введенного до большего включительно, с шагом 1.
// Разделитель пробел. Если пользователь ввел 4 и 8  и нажал кнопку, мы получим:
//     4 5 6 7 8
...
function t9() {
    let counter = '',
        input91Val = document.querySelector('.i-91').value,
        input92Val = document.querySelector('.i-92').value

    if (+input91Val < +input92Val)
        for (let i = +input91Val; i <= +input92Val; i++)
            counter+= i + ' '
    else
        for (let i = +input92Val; i <= +input91Val; i++)
            counter+= i + ' '
...
function t10() {
    ...
    for (let i = 1950; i < 2001; i += 2)
        counter += i + ' '
    document.querySelector('.out-10').textContent = counter
}
...
function t14() {
    ...
    arr.forEach((i) => {
        if (i.checked)
            document.querySelector('.out-14').textContent = i.value
    })
}
