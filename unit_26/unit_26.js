...
function t2() {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Mark')
            .then((data) => {
                return data.text()
            })
            .then(data => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num2=213121&num2=123123')
        .then((data) => {
            return data.text()
        })
        .then(data => {
...
Не забывайте указывать параметр auth (ключ в чате).
 Выведите в out-4 результат. Запускаться функция должна по нажатию b-4. */

function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num2=213121&num2=123123')
        .then((data) => {
            return data.text()
        })
        .then(data => {
...
/*  Отправьте GET запрос (fetch) на сайт http://getpost.itgid.info/index2.php.
 В качестве action укажите 6. Добавьте параметр num1 и num2 содержащие числа.
  Если все сделано верно, сервер вернет большее число. Не забывайте указывать параметр auth
   (ключ в чате). Выведите в out-6 результат. Запускаться функция должна по нажатию b-6. */

function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num2=213121&num2=123123')
        .then((data) => {
            return data.text()
        })
        .then(data => {
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1996')
        .then((data) => {
            return data.text()
        })
        .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Mark', {
        ...
        redirect: 'follow', // manual, *follow, error
        referrerPolicy: 'no-referrer', // no-referrer, *client
        body: 'auth=5ADcB96BA48d3f80&action=2&name=Mark' // body data type must match "Content-Type" header
    })
        .then((data) => {
            return data.text()
        })
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num2=213121&num2=123123', {
        ...
        redirect: 'follow', // manual, *follow, error
        referrerPolicy: 'no-referrer', // no-referrer, *client
        body: 'auth=5ADcB96BA48d3f80&action=3&num2=213121&num2=123123' // body data type must match "Content-Type" header
    })
        .then((data) => {
            return data.text()
        })
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num2=213121&num2=123123', {
        ...
        redirect: 'follow', // manual, *follow, error
        referrerPolicy: 'no-referrer', // no-referrer, *client
        body: 'auth=5ADcB96BA48d3f80&action=4&num2=213121&num2=123123' // body data type must match "Content-Type" header
    })
        .then((data) => {
            return data.text()
        })
...
/*  Отправьте POST запрос (fetch) на сайт http://getpost.itgid.info/index2.php.
 В качестве action укажите 5. Если все сделано верно, сервер вернет текущее время и дату. Не забывайте указывать параметр auth (ключ в чате). Выведите в out-14 результат. Запускаться функция должна по нажатию b-14.*/
...
function t14() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=5', {
        ...
        redirect: 'follow', // manual, *follow, error
        referrerPolicy: 'no-referrer', // no-referrer, *client
        body: 'auth=5ADcB96BA48d3f80&action=4' // body data type must match "Content-Type" header
    })
        .then((data) => {
            return data.text()
        })
...
// Task 15============================================
/*  Отправьте POST запрос (fetch) на сайт http://getpost.itgid.info/index2.php.
В качестве action укажите 6. Добавьте параметр num1 и num2 содержащие числа. Если все сделано верно, сервер вернет большее число. Не забывайте указывать параметр auth (ключ в чате). Выведите в out-15 результат. Запускаться функция должна по нажатию b-15. */
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num2=213121&num2=123123', {
        ...
        redirect: 'follow', // manual, *follow, error
        referrerPolicy: 'no-referrer', // no-referrer, *client
        body: 'auth=5ADcB96BA48d3f80&action=6&num2=213121&num2=123123' // body data type must match "Content-Type" header
    })
        .then((data) => {
            return data.text()
        })
...
// Task 17 ============================================
/*  Отправьте POST запрос (fetch) на сайт http://getpost.itgid.info/index2.php.
В качестве action укажите 8. В качестве параметра по очереди укажите year равный году вашего рождения. Если все правильно сервер вернет ваш возраст. Не забывайте указывать параметр auth (ключ в чате).Выведите в out-17 результат. Запускаться функция должна по нажатию b-17. */
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1996', {
        ...
        redirect: 'follow', // manual, *follow, error
        referrerPolicy: 'no-referrer', // no-referrer, *client
        body: 'auth=5ADcB96BA48d3f80&action=8&year=1996' // body data type must match "Content-Type" header
    })
        .then((data) => {
            return data.text()
        })
