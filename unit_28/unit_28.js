 ...
 // заполните свойства, примените метод draw для вывода товара на страницу в блок
 // out-4.
let goods2 = new Goods('iphone', 23, 'https://images.pexels.com/photos/4348270/pexels-photo-4348270.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', 666)
 goods2.draw('.out-4')
 ...
 // И метод validate. Метод validate должен проверять длину пароля и писать false в isValid
 ...
 let valid = new Valid('qwe@qwe.ru', '12345')
 valid.validate()
 ...
 let valida = new Valid('qwe@qwe.ru', '1234567')
 valida.validate()
 ...
 //Task 11.
 // Создайте на основе класса Valid2 объект valid2 и
 // задайте пустой емейл и длину пароля больше 7.
 // Запустите метод validate(). Выведите объект в консоль.
  let valid2 = new Valid2('', '1234567')
  valid2.validate()
  console.log(valid2)
 //Task 12.
 // Создайте на основе класса Valid2 объект valid3 и
 // задайте не пустой емейл и длину пароля больше 7.
 // Запустите метод validate(). Выведите объект в консоль.
 let valid3 = new Valid2('qweqw@weq.ru', '12345678')
 valid3.validate()
 console.log(valid3)
