...
// Функция должна вывести в out-9 значения из массива a9,
// которые больше нуля. Используем цикл. Вывод - через пробел.
...
// Функция должна вывести в out-10 значения из массива a10,
// которые являются строкой. Используем цикл. Вывод - через пробел.
...
function f15() {
    let reducer = a15.reduce((a, b) => (a.length > b.length ? a : b), "");

    document.querySelector('.out-15').textContent = reducer.length
}
