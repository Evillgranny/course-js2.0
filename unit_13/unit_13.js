...
// которая принимает массив как параметр и выводит
...
// Функция должна получать из i-61 ключ,
// а из i-62 значение и добавлять его в массив a6.
...
function f6() {
    ...
    let inputVal = document.querySelector('.i-62').value
    a6[inputKey] = inputVal
    f5(a6, '.out-6')
}
...
// Функц.ия должна получать из i-7 ключ.
...
// Функция должна выводить значение в out-8, если ключ введенный в i-8 есть в массиве,
// если нет - 0.
...
function f8() {
    ...
    if (a8[inputValue])
        document.querySelector('.out-8').textContent = a8[inputValue]
    else
...
// Task 12
//  При нажатии b-12 выполняете функцию f12. Функция должна получить значение из i-12
//  и удалить запись из массива a12 с таким значением.
...
// которую пользователь ввел в i-18. Вывод станций - через пробел.
