...
function t2() {
    ...
    xHTTP.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Mark', true)
    xHTTP.send()
}
...
function t3() {
    ...
    xHTTP.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=23&num2=465', true)
    xHTTP.send()
}
...
function t4() {
    ...
    xHTTP.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=23&num2=465', true)
    xHTTP.send()
}
...
function t6() {
    ...
    xHTTP.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=23&num2=465', true)
    xHTTP.send()
}
...
function t8() {
    ...
    xHTTP.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1996', true)
    xHTTP.send()
}
...
function t11() {
    ...
    xHTTP.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Mark', true)
    xHTTP.send()
}
...
function t12() {
    ...
    xHTTP.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=4&num2=3', true)
    xHTTP.send()
}
...
function t13() {
    ...
    xHTTP.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=4&num2=3', true)
    xHTTP.send()
}
...
function t15() {
    ...
    xHTTP.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=123&num2=12414', true)
    xHTTP.send()
}
...
function t17() {
    ...
    xHTTP.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1996', true)
    xHTTP.send()
}
