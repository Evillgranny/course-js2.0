...
let ar1 = ['str', 'str2', 21, 3, true, false] // переменную обьявляем здесь!!!!
...
let ar2 = ['str', 'str2', 21, 3, true, false]// переменную обьявляем здесь!!!!
...
function f5() {
    document.querySelector('.out-5').textContent = `${ar4[0] + ar4[2]+ ar4[3]}`
}
...
// Разделитель - пробел. Обращаю ваше внимание! Это программирование. Поэтому - никаких больших букв и тому подобного!!!!
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
