...
document.querySelector('.three').innerHTML = '<h3>Детские коленки в мультиварке</h3>'
...
document.querySelector('.four').innerHTML = `<div><h4>Заголовок</h4><p>Параграф</p></div>`
