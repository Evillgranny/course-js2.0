...
function f5() {
    ...
    if (check.checked)
        document.querySelector('.out-5').textContent = check.value
    else
...
function f6() {
    ...
    document.querySelector('.out-6').textContent = input6.value
}
...
function f7() {
    ...
    document.querySelector('.out-71').textContent = input7.value
...
// Task 8.
// Создайте div.out-8 и кнопку .b-8. При нажатии кнопки
// создавайте внутри div.out-8 элемент input.i-81 и кнопку
// .b-81 (innerHTML). Добавьте на созданную кнопку событие
// клик и запуск функции f81. Функция должна в .out-81 выводить
// value созданного input.i-81.

function f8() {
    let container = document.querySelector('.out-8'),
        input =  document.createElement('input'),
        btn = document.createElement('button')

    input.type = 'text'
    input.className = 'i=81'

    btn.className = 'b-81'
    btn.innerHTML = 'клац клац'
    btn.onclick = () => {
        document.querySelector('.out-81').innerHTML = input.value
    }
...
function f10() {
    ...
    document.querySelector('.out-10').style.background = input10
}
...
function f11() {
    let input111 = document.querySelector('.i-111'),
        input112 = document.querySelector('.i-112')
...
function f12() {
    ...
    document.querySelector('.out-12').textContent = input12.value
}
...
function f13() {
    ...
    input13.oninput = () => {
        document.querySelector('.out-13').textContent = input13.value
    }
}
...
function f14() {
    ...
    document.querySelector('.out-14').textContent = textarea14.value
}
...
// - при нажатии на кнопку выводите текст из input.i-15 в textarea.t-15 и на страницу в out-15.

function f15() {
    let textarea15 = document.querySelector('.t-15'),
        input15 = document.querySelector('.i-15')


    textarea15.value = input15.value
    document.querySelector('.out-15').textContent = input15.value
}
...
function f16() {
    ...
    document.querySelector('.out-16').textContent = select16.value
}
...
function f17() {
    ...
    document.querySelector('.out-17').textContent = select17.value
}
...
function f18() {
    ...
    document.querySelector('.i-18').value = sel.value
}
...
function f19() {
    let input191 = document.querySelector('.i-191'),
        input192 = document.querySelector('.i-192')
    document.querySelector('.out-19').textContent = `${input191.value} ${input192.value}`
}

document.querySelector('.b-19').onclick = f19;

// Task 20
// Создайте форму .f-20. В ней input(text) и input(password)
// - и кнопку button.b-20. По нажатию кнопки выводите
// значение из input text и password в out-20 через пробел.
...
function f20(e) {
    ...
    let form = document.querySelector('.f-20'),
        inputText = form.elements['username'].value,
        inputPass = form.elements['password'].value
    document.querySelector('.out-20').textContent = `${inputText} ${inputPass}`
}
