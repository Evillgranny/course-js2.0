...
// Task 2
//Напишите функцию f2, которая применяет метод pop к массиву d1,
// а затем выводит его (showArr) в .out-2
...
// Task 8
// Напишите функцию f8, которая эмулирует работу метода unShift
// - добавляем значение из i-8 в начало массива d8.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f8() {
    let arr = []
    arr[0] = document.querySelector('.i-8').value
    for (let i = 1; i <= d8.length; i++)
        arr[i] = d8[i -1]
    d8 = arr
    showArr('.out-8', d8);
}
...
// переводит в число, и с помощью метода indexOf проверяет
// наличие в массиве d11. Функция выводит в out-11 -1
...
function f11() {
    ...
    out.textContent = d11.indexOf(+inputValue)
}
...
// Task 16
// Даны два массива d161 и d162 - используя метод concat - добавьте в массив d16 результат
// применения concat между массивом d161 и d162.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
// Task 18
// Напишите функцию f18, которая получает значение из i-18 и
// проверяет есть ли такое значение в массиве d18 c использованием метода include.
...
function f19() {
    for (let i = 0; i < d19.length; i++)
        if (i === 0 || d19[i].length > maxString.length)
            maxString = d19[i]
...
// параметрами и соединяет элементы массива в одну строку.
